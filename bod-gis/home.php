...
<body>
    ...
    <div class="header">
        <h1><?= translate("BoD GIS Province's Dashboard", $language) ?></h1>
    </div>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <!-- Data Table -->
            <table id="dataTable">
                <caption style="font-size: 1.5em; font-weight: bold; margin-bottom: 10px;"><?= translate('Pending Approval List', $language) ?></caption>
                <thead>
                    <tr>
