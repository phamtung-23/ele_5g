...
// Get the department from session role (assuming role represents department)
$department = isset($_SESSION['role']) ? $_SESSION['role'] : ''; 
...
<body>
    ...
    <div class="menu">
        ...
        <a href="update_sector.php">Update Sectors</a>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th>Azimuth</th>
                    <th>Windy Area</th>
                    <th>Poles on the roof or on the ground</th>
                    <th>Height of Tower (m)</th>
                    <th>Type of Tower</th>
                    <th>Size of Tower</th>
                    <th>Column body tube diameter</th>
                    <th>Height ANT 8Ports</th>
                    <th>Height ANT 10Ports</th>
                    <th>Height ANT 12Ports</th>
                    <th>Height AAU Massive MIMO</th>
                    <th>Height ANT 2Ports (1.8-2.1)</th>
                    <th>Height ANT 2Ports (900)</th>
                    <th>Height ANT 4Ports High Gain</th>
                    <th>Height ANT 2Ports (1800)</th>
                    <th>Height ANT 4Ports</th>
                    <th>Total ANT</th>
                    <th>Height RRU 2G 1800</th>
                    <th>Height RRU 2G 900</th>
                    <th>Height RRU 4G 850</th>
                    <th>Height RRU 4G 1.8</th>
                    <th>Height RRU 4G 2.1</th>
                    <th>Height RRU 4G 2.6</th>
                    <th>Height RRU DB</th>
                    <th>Height RRU TrB</th>
                    <th>Total RRU</th>
                    <th>Height Viba D=0.6</th>
                    <th>Height Viba D=0.9</th>
                    <th>Height Viba D=1.2</th>
                    <th>Height Viba D=1.8</th>
                    <th>Survey Image</th> <!-- New column for multiple images -->
                </tr>
            </thead>
            <tbody>
                <tr>
