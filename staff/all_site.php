                    ...
                    <?php if (!empty($data)): ?>
                        ...
                        foreach ($data[$userEmail] as $key => $value): 
                            foreach ($value['list'] as $item):
                                ...
                                // get approval status by office_vtc role
                                if (!empty($stationData)) {
                                    $approvalStatusOfficeVtc = getApprovalStatusByRole($stationData['approval'], 'office_vtc');
                                } else {
                                    $approvalStatusOfficeVtc = [];
                                }
                                ...
                                $statusOfficeVtc = empty($approvalStatusOfficeVtc) ? '': htmlspecialchars($approvalStatusOfficeVtc['status']);
                                ...
                                $colorsLevel = [ 'pending' => '#FF8C00', 'rejected' => '#8B0000', 'approved' => '#008000', '' => 'black' ];
                                $colorTextLevelBodProGis = $colorsLevel[$statusBodProGis];
                                $colorTextLevelOfficeGis = $colorsLevel[$statusOfficeGis];
                                $colorTextLevelOfficeVtc = $colorsLevel[$statusOfficeVtc];
